#include "plotter.h"
#include <QDebug> // Usado para fazer depuração e ao invés de usar o cout o QDebug mostra as informações na saída do QT
// é usado desta forma qDebug() << "alo"; Depois do operador de sobrecarga o dado mostrado pode ser qualquer um.
#include <QBrush>
#include <QPen>
#include <QPainter>
